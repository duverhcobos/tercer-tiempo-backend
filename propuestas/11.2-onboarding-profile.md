...
**Estado:** ✅ Completado — superada por `11.3-onboarding-profile.md` (corrige el orden stub del service y agrega el mapper de aplicación obligatorio), pero el resultado final ya está en `src/`.
